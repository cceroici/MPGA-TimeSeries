...
def get_args():
    ...
    parser.add_argument("--conduit_solve_depth", help="Number of iterations for evaluating conduit node paths", type=int, default=1)
...
def run(args, load_model=False):
    ...
    if (validate_model and not train_model) or load_model:
        ...
        #species_configs = [winner_config]                                       # Use a single popuation
